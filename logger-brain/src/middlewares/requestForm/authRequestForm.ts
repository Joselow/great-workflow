...
import { verifyLoginSchema, verifyRegisterSchema } from "../../validations/authValidation.js";
...
export const registerRequestForm = (req: Request, res: Response, next: NextFunction): void => {
...
export const loginRequestForm = (req: Request, res: Response, next: NextFunction): void => {
