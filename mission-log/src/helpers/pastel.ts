...
const PALETTES: PastelPalette[] = [
    ...
    { bg: 'bg-brand-mint', text: 'text-white', border: 'border-brand-mint/50 dark:border-brand-mint/40', dot: 'bg-brand-mint' },
    { bg: 'bg-brand-yellow', text: 'text-white', border: 'border-brand-yellow/50 dark:border-brand-yellow/40', dot: 'bg-brand-yellow' },
]
