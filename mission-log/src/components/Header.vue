...
const classHeader = props.full 
                          ? '' 
                          : 'max-w-2xl rounded-lg '

const { modalConfirm, onModalConfirm } = useShowStates("modalConfirm");
...
<template>
  ...
  <div>
    ...
    />
    <header class="rounded-lg mx-auto sticky top-0 z-10 bg-white/70 dark:bg-black/40 backdrop-blur-sm border shadow-lg border-black/5 dark:border-white/10 shadow-sm"
      :class="classHeader"
    >
      ...
      >
        ...
        <button class="cursor-pointer text-xl hover:bg-rose-50 dark:hover:bg-rose-950/40 px-3 py-1 rounded-full text-rose-400 transition-colors"
          title="Logout"
